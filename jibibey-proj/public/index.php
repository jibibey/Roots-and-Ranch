  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition">
      ...
      <div class="p-4">
        ...
        <a href="/jibibey-proj/public/shop-now/rice.php" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">Shop Now</a>
      </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition">
      ...
      <div class="p-4">
        ...
        <a href="/shop-now/vegetables.php" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">Shop Now</a>
      </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition">
      ...
      <div class="p-4">
        ...
        <a href="/shop-now/fruits.php" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">Shop Now</a>
      </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition">
      ...
      <div class="p-4">
        ...
        <a href="/shop-now/eggs.php" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">Shop Now</a>
      </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition">
      ...
      <div class="p-4">
        ...
        <a href="/shop-now/milk.php" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">Shop Now</a>
      </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition">
      ...
      <div class="p-4">
        ...
        <a href="/shop-now/chicken.php" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">Shop Now</a>
      </div>
    </div>

    <!-- Show All -->
    <div class="bg-blue-600 text-white flex items-center justify-center rounded-xl shadow-md hover:bg-blue-700 transition">
      <a href="/shop-now/all-products.php" class="text-lg font-semibold py-16 px-8">Show All Products →</a>
    </div>
